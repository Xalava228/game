...
try{
 ...
 await tap(195,798);check((await save()).level===2,'touch advances one level');await tap(297,751);await tap(195,430,150);s=await save();check(s.physicalHits===1,'short touch is one physical attack');
