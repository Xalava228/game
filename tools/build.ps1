...
$buildProcess=Start-Process -FilePath 'D:\UnityHub\6000.3.23f1\Editor\Unity.exe' -ArgumentList @('-batchmode','-nographics','-quit','-projectPath',('"'+$taskRoot+'\game"'),'-buildTarget','WebGL','-executeMethod',$method,'-logFile','D:\Game\Work\Logs\unity-build.log','-upmLogFile','D:\Game\Work\Logs\upm.log') -WindowStyle Hidden -PassThru
